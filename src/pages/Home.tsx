        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-1.5 lg:gap-8 items-start lg:items-center">
            ...
            <div className="flex flex-col lg:gap-1.5 w-full lg:w-auto">
               ...
               <div className="flex overflow-x-auto lg:overflow-visible no-scrollbar -mx-4 px-4 lg:mx-0 lg:px-0 gap-1 p-0.5 bg-slate-100/50 md:bg-slate-100/80 rounded-lg md:rounded-xl shrink-0">
                {GRADES.map(grade => (
                  <button
                    key={grade}
                    onClick={() => {
                    ...
                    className={`px-3 md:px-5 py-1.5 md:py-2 rounded-lg text-[10px] md:text-sm font-black uppercase tracking-widest transition-all duration-300 relative whitespace-nowrap ${
                      selectedGrade === grade 
                      ? 'text-white' 
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {SUBJECTS.map(sub => (
                      <button
                        ...
                        className={`px-3 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all border-2 ${
                          selectedSubject === sub
